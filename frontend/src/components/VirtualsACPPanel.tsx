  ...
  return (
    ...
    >
      <div>
        ...
        >
          Data: Inter-agent signal registration, reputation score, job protocol
          broadcasting, and peer communication logs.
        </p>
      </div>
      ...
      >
        ...
        >
          <div>
            <h4
              className="neo-title"
              style={{ fontSize: "1.05rem", color: "#000000", margin: 0 }}
            >
              Agent ACP Identity
            </h4>
            <p
        ...
        >
          ...
          >
            ...
            <p
              style={{ fontSize: "0.85rem", fontWeight: 900, marginTop: "2px" }}
            >
              {registry?.protocol}
            </p>
          </div>
      ...
      >
        <h4
          className="neo-title"
          style={{ fontSize: "0.95rem", color: "#000000", marginBottom: "8px" }}
        >
