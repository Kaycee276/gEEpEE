  ...
  return (
    ...
    >
      <div>
        ...
        >
          Data: Hackathon Litmus Gate verification directives, Base network gas
          specs, Virtuals ACP protocols, and SQLite DB disk statistics.
        </p>
      </div>
      ...
      >
        <h4
          className="neo-title"
          style={{ fontSize: "0.95rem", color: "#000000", marginBottom: "6px" }}
        >
        ...
        >
          ...
          <code style={{ wordBreak: "break-all" }}>backend/agent_brain.py</code>{" "}
          lines 32–55. When load-bearing memory is deleted,{" "}
      ...
      >
        <h4
          className="neo-title"
          style={{ fontSize: "0.9rem", color: "#000000", marginBottom: "8px" }}
        >
